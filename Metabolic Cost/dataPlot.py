...
axs[0, 0].plot(data[0][:,0], 'bo', markersize=1)
axs[1, 0].plot(data[0][:,1], 'bo', markersize=1)
axs[2, 0].plot(data[0][:,2], 'bo', markersize=1)
axs[3, 0].plot(data[0][:,3], 'bo', markersize=1)
axs[4, 0].plot(data[0][:,4], 'bo', markersize=1)
...
axs[0, 1].plot(data[1][:,0], 'bo', markersize=1)
axs[1, 1].plot(data[1][:,1], 'bo', markersize=1)
axs[2, 1].plot(data[1][:,2], 'bo', markersize=1)
axs[3, 1].plot(data[1][:,3], 'bo', markersize=1)
axs[4, 1].plot(data[1][:,4], 'bo', markersize=1)
...
axs[0, 2].plot(data[2][:,0], 'bo', markersize=1)
axs[1, 2].plot(data[2][:,1], 'bo', markersize=1)
axs[2, 2].plot(data[2][:,2], 'bo', markersize=1)
axs[3, 2].plot(data[2][:,3], 'bo', markersize=1)
axs[4, 2].plot(data[2][:,4], 'bo', markersize=1)
...
axs[0, 3].plot(data[3][:,0], 'bo', markersize=1)
axs[1, 3].plot(data[3][:,1], 'bo', markersize=1)
axs[2, 3].plot(data[3][:,2], 'bo', markersize=1)
axs[3, 3].plot(data[3][:,3], 'bo', markersize=1)
axs[4, 3].plot(data[3][:,4], 'bo', markersize=1)
