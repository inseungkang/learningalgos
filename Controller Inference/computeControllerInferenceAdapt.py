...
for ii in np.arange(5):
    ...
    axs[0,5].plot(slowgainX_result[ii][:,0],'.')
    axs[0,6].plot(slowgainX_result[ii][:,1],'.')
    axs[0,7].plot(slowgainX_result[ii][:,2],'.')
    axs[0,8].plot(slowgainX_result[ii][:,3],'.')
    axs[0,9].plot(slowgainX_result[ii][:,4],'.')
    ...
    axs[1,5].plot(slowgainY_result[ii][:,0],'.')
    axs[1,6].plot(slowgainY_result[ii][:,1],'.')
    axs[1,7].plot(slowgainY_result[ii][:,2],'.')
    axs[1,8].plot(slowgainY_result[ii][:,3],'.')
    axs[1,9].plot(slowgainY_result[ii][:,4],'.')
