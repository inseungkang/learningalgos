...
for file in file_info:
    ...
    if delta == 4:
        ...
        for ii in np.arange(45):
            start, end = CIF.find_evaluting_range_idx_time(ii, 1, gait_event_idx)
            # print(str(start)+" "+str(gait_event_idx.shape)+" "+str(gait_event_idx[start,0]))
...
# file = open('controllerInferenceAdapt.pkl','wb')
...
#     axs[0,5].plot(slowgainX_result[ii][:,0],'o')
#     axs[0,6].plot(slowgainX_result[ii][:,1],'o')
#     axs[0,7].plot(slowgainX_result[ii][:,2],'o')
#     axs[0,8].plot(slowgainX_result[ii][:,3],'o')
#     axs[0,9].plot(slowgainX_result[ii][:,4],'o')
...
#     axs[1,5].plot(slowgainY_result[ii][:,0],'o')
#     axs[1,6].plot(slowgainY_result[ii][:,1],'o')
#     axs[1,7].plot(slowgainY_result[ii][:,2],'o')
#     axs[1,8].plot(slowgainY_result[ii][:,3],'o')
#     axs[1,9].plot(slowgainY_result[ii][:,4],'o')
