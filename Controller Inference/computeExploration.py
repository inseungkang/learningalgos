...
for subjectname in ['AB1', 'AB2', 'AB3', 'AB4', 'AB5']:
    ...
    for file in newlist:
        ...
        result_fast_x.append(UF.filt_outlier(split_fast_rmse_x))
        result_fast_y.append(UF.filt_outlier(split_fast_rmse_y))
        result_slow_x.append(UF.filt_outlier(split_slow_rmse_x))    
...
# axs[3].set_ylim([25, 100])
# axs[4].set_ylim([25, 100])
