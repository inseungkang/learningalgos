...
# Pelvis position is the mean of 4 pelvis markers
pelvisPosX = np.mean(mkr[0:3,0,1:], axis=0)
pelvisPosY = np.mean(mkr[0:3,1,1:], axis=0)
pelvisPosZ = np.mean(mkr[0:3,2,1:], axis=0)
